...
export default defineConfig({
  ...
  reporter: 'list',
  use: {
    baseURL: 'http://localhost:4668/crypto-lab-salamander/',
    colorScheme: 'dark',
  },
  webServer: {
    ...
    command: 'npm run build && npm run preview -- --port 4668 --strictPort',
    url: 'http://localhost:4668/crypto-lab-salamander/',
